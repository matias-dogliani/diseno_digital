...
Ejemplo: DeFix_object=DeFixedInt(totalWidth=15, fractWidth=15, signedMode = 'S', roundMode='trunc', saturateMode='saturate')

-->totalWidth=Numero Entero Positivo. Cantidad de bits totales de la palabra. Por defecto 0
...
a=DeFixedInt(roundMode='trunc',signedMode = 'S',totalWidth=4,fractWidth=2,saturateMode='saturate') # Definicion completa de un objeto de la clase con la posicion de los parametros cambiada
...
--> .fValue: Atributo. 
             ...
             de la clase (totalWidth=0, fractWidth=15,signedMode = 'S', roundMode='trunc', saturateMode='saturate').
--> .intvalue: Atributo. 
...
arrayObjetos = arrayFixedInt(totalWidth, fractWidth, N, signedMode='S', roundMode='trunc', saturateMode='saturate')
